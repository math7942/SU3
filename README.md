...
02-lab/                 2. 수학실험 (아래 11개 실험실)
  ...
  11-experience/          수학체험
03-work/                3. 업무 도구
04-festival/            4. AI와 함께하는 수학교사의 1학기 살이
05-susu/                5. 수수
...
| 업무 도구 | `03-work/interview-prep.html` | 면접+논술+실기+적성 (편성표) |
| 업무 도구 | `03-work/apply-print.html` | 원서접수 출력 (학생별 A4 가로 1페이지) |

AI와 함께하는 수학교사의 1학기 살이는 `04-festival/`에 8단계 가이드·도구로 전체 공개됐습니다. 수수는 아직 비어 있습니다.
